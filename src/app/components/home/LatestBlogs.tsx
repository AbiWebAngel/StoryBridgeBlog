...
const blogData = [
  {
    ...
    content: [
      <div key="content1" className="space-y-4 text-[16px] sm:text-[17px] lg:text-[18px] font-inter">
        In honour of one of our bloggers turning 15, here are{" "}
        <span style={{ color: "#CF822A", fontWeight: 600 }}>15 motivational quotes</span>{" "}
        to start your day off sprinting (writing sprints). <br />
        <br />
  ...
  },
  {
    ...
    content: [
       <div key="content2" className="space-y-4 text-[16px] sm:text-[17px] lg:text-[18px] font-inter">
  ...
  },
  {
    ...
    image: "/assets/images/home/blog1.jpg",
    content: [
       <div key="content3" className="space-y-4 text-[16px] sm:text-[17px] lg:text-[18px] font-inter">
        ...
        <br />
        <strong>“Voice isn’t something you find—it’s something you allow,”</strong> she said.
  ...
  },
  {
    ...
    image: "/assets/images/home/blog2.jpg",
    content: [
       <div key="content4" className="space-y-4 text-[16px] sm:text-[17px] lg:text-[18px] font-inter">
