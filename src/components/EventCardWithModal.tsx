...
export default function EventCardWithModal({
  ...
  return (
    <>
      ...
      <div className="sm:hidden overflow-y-visible pb-4">
          ...
          {eventData.map((event) => {
            ...
            return (
              <article key={event.id}>
                <div className="bg-[#EDE5D8] rounded-[24px] shadow-lg p-5 flex flex-col">
                  <div className="relative h-40 w-full mb-4 rounded-[20px] overflow-hidden">
                    <Image
                      src={event.image.src}
                      alt={event.image.alt}
                      fill
                  ...
                  <h3 className="font-cinzel font-bold text-[18px] uppercase mb-2">
                    {event.title}
                  </h3>

                  <p className="flex items-center text-[14px] font-jacques-francois text-[#403727] mb-2">
                  ...
                  <p className="text-[14px] font-jacques-francois text-[#403727] mb-4">
                    {event.description}
                  </p>

                  <button
                    onClick={() => handleOpenModal(event)}
                    className="mt-auto bg-[#805C2C] text-white px-4 py-2 rounded-full text-[14px]"
                  >
                    Learn More
                  </button>
                </div>
